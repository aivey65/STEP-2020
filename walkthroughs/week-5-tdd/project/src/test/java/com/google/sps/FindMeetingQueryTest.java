...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsidered_IncludesOptionalPersonC() {
    // Have each person have different events. We should see two options, in the beginning and end
    // of the day, because there are still two events with the inclusion of person c.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsidered_IgnoreBusyOptionalPersonC() {
    // Have each person have different events. We should see three options because person C is
    // optional, and they are busy the whole day.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void noMandatoryAttendeesOrGaps_NoAvailableTimes() {
    // Have each person have different events. No mandatory attendees, just two optional attendees
    // with no gaps in their schedules. Should return no time available.
    // Events  : |-------------A---------------|
    //           |-------------B---------------|
    // Day     : |-----------------------------|
    // Options : 
